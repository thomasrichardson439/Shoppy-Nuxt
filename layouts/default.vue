<template>
    <div>
                                        ...
                                        >
                                            <div class="rounded-lg shadow-lg">
                                                ...
                                                >
                                                    ...
                                                    <div
                                                        class="px-5 py-5 bg-gray-50 space-y-5 sm:px-8 sm:py-8"
                                                    >
                                                        <div class="space-y-4">
                                                            <h3
        ...
        <div>
            <div v-bind:class="footerClassObject">
                <div
                    ...
                    <div class="xl:grid xl:grid-cols-3 xl:gap-8">
                        <div class="xl:col-span-1">
                            ...
                            <p class="mt-8 text-gray-500 text-base leading-6">
                                Accept payments, sell digital products from your
                                own and more, do it all with a single platform.
                            </p>
                            <div class="mt-8 flex">
                                <a
            ...
            <div class="bg-darkbluely">
                <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div
                        class="flex flex-col items-center justify-between md:flex-row py-4"
                    >
                        <div>
                            <span class="text-white"
...
export default {
    ...
    mounted() {
        ...
        const keys = Object.keys(this.dropdowns)
