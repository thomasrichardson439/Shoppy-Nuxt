    ...
    <div class="wrapper">
        <div class="absolute w-full">
            <img
                ...
                src="~/assets/images/pricing/pricing-bg-c.png"
            />
        </div>
                ...
                <div class="xl:grid xl:grid-cols-3 xl:gap-8">
                    <div class="xl:col-span-1">
                        ...
                        <p class="mt-8 text-gray-500 text-base leading-6">
                            Accept payments, sell digital products from your own
                            and more, do it all with a single platform.
                        </p>
                        <div class="mt-8 flex">
                            <a
                                href="#"
                ...
                >
                    ...
                    <div class="flex mt-4 md:m-0">
                        <div class="-mx-4">
                            ...
                            <a href="#" class="px-2 text-sm"
                                >Shoppy Ecommerce Ltd. &copy; 2020</a
                            >
                        </div>
                    </div>
                </div>
