<template>
    <div>
            ...
            <div class="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-screen-xl">
                ...
                <div class="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
                        ...
                        <ul class="mt-10">
                            ...
                            <li class="mt-10">
                                <div class="flex">
                                    ...
                                    <div class="ml-4">
                                        <h5 class="text-lg leading-6 font-medium text-gray-900">No hidden fees
                                        </h5>
                                        <p class="mt-2 text-base leading-6 text-gray-500">
                                            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit
                                            perferendis suscipit eaque, iste dolor cupiditate blanditiis ratione.
                            ...
                            <li class="mt-10">
                                <div class="flex">
                                    ...
                                    <div class="ml-4">
                                        <h5 class="text-lg leading-6 font-medium text-gray-900">Transfers are instant
                                        </h5>
                                        <p class="mt-2 text-base leading-6 text-gray-500">
                                            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit
                                            perferendis suscipit eaque, iste dolor cupiditate blanditiis ratione.
                    ...
                    <div class="mt-10 -mx-4 relative lg:mt-0">
                        ...
                        <img class="relative mx-auto" width="490" src="~assets/images/payments.png" alt=""/>
                    </div>
                </div>
                            ...
                            <ul class="mt-10">
                                <li>
                                    <div class="flex">
                                        ...
                                        <div class="ml-4">
                                            <h5 class="text-lg leading-6 font-medium text-gray-900">Mobile notifications
                                            </h5>
                                            <p class="mt-2 text-base leading-6 text-gray-500">
                                ...
                                <li class="mt-10">
                                    <div class="flex">
                                        ...
                                        <div class="ml-4">
                                            <h5 class="text-lg leading-6 font-medium text-gray-900">Reminder emails
                                            </h5>
                                            <p class="mt-2 text-base leading-6 text-gray-500">
                                                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores
                                                impedit perferendis suscipit eaque, iste dolor cupiditate blanditiis
        ...
        <div class="bg-ecommerce p-10">
            <div class="container mx-auto">
                <div class="text-center">
                    <div class="text-3xl text-white font-medium">
                        Create your own shop within seconds
                    </div>
                    <div class="text-1xl text-gray-400">
                        Sustainable and designed for your audience
                    </div>
                </div>

                <div class="shoppy-ecommerce--cycle-grid">
                    <div class="shoppy-ecommerce--cycle-grid-arrow-right">
                        <img src="~assets/images/ecommerce/arrow-right.svg">
                    </div>
                    <div class="shoppy-ecommerce--cycle-grid-arrow-down">
                        <img src="~assets/images/ecommerce/arrow-down.svg">
                    </div>
                    <div class="shoppy-ecommerce--cycle-grid-arrow-left">
                        <img src="~assets/images/ecommerce/arrow-left.svg">
                    </div>
                    <div class="shoppy-ecommerce--cycle-grid-arrow-up">
                        <img src="~assets/images/ecommerce/arrow-up.svg">
                    </div>

                    <div class="shoppy-ecommerce--cycle-grid-step-1">
                        <div class="shoppy-ecommerce--cycle-grid-grid-item p-4">
                            <div class="shoppy-ecommerce--cycle-grid-grid-image relative mx-auto">
                                <img src="https://ghost.org/images/members/members-step-1.png">
                            </div>
                            <div class="text-center">
                                <div class="uppercase text-sm text-lightpink mt-4">Step 1</div>
                                <div class="text-white text-2xl font-medium">Lorem ipsum</div>
                    ...
                    <div class="shoppy-ecommerce--cycle-grid-step-2">
                        <div class="shoppy-ecommerce--cycle-grid-grid-item p-4">
                            <div class="shoppy-ecommerce--cycle-grid-grid-image relative mx-auto">
                                <img src="https://ghost.org/images/members/members-step-1.png">
                            </div>
                            <div class="text-center">
                                <div class="uppercase text-sm text-lightpink mt-4">Step 2</div>
                                <div class="text-white text-2xl font-medium">Lorem ipsum</div>
                                <div class="text-sm text-gray-400 mt-3">
                                    Corporis quisquam nostrum nulla veniam recusandae temporibus aperiam officia
                                    incidunt at distinctio ratione.
                    ...
                    <div class="shoppy-ecommerce--cycle-grid-step-3">
                        <div class="shoppy-ecommerce--cycle-grid-grid-item p-4">
                            <div class="shoppy-ecommerce--cycle-grid-grid-image relative mx-auto">
                                <img src="https://ghost.org/images/members/members-step-1.png">
                            </div>
                            <div class="text-center">
                                <div class="uppercase text-sm text-lightpink mt-4">Step 3</div>
                                <div class="text-white text-2xl font-medium">Lorem ipsum</div>
                                <div class="text-sm text-gray-400 mt-3">
                                    Corporis quisquam nostrum nulla veniam recusandae temporibus aperiam officia
                                    incidunt at distinctio ratione.
                    ...
                    <div class="shoppy-ecommerce--cycle-grid-step-4">
                        <div class="shoppy-ecommerce--cycle-grid-grid-item p-4">
                            <div class="shoppy-ecommerce--cycle-grid-grid-image relative mx-auto">
                                <img src="https://ghost.org/images/members/members-step-1.png">
                            </div>
                            <div class="text-center">
                                <div class="uppercase text-sm text-lightpink mt-4">Step 4</div>
                                <div class="text-white text-2xl font-medium">Lorem ipsum</div>
                                <div class="text-sm text-gray-400 mt-3">
                                    Corporis quisquam nostrum nulla veniam recusandae temporibus aperiam officia
                                    incidunt at distinctio ratione.
            ...
            <div class="max-w-xl mx-auto px-4 sm:px-6 lg:max-w-screen-xl lg:px-8">
                <div class="lg:grid lg:grid-cols-3 lg:gap-8">
                    <div>
                        ...
                        <div class="mt-5">
                            <h5 class="text-lg leading-6 font-medium text-gray-900">Competitive exchange rates
                            </h5>
                            <p class="mt-2 text-base leading-6 text-gray-500">
