    ...
    <div class="wrapper">
        ...
        <div class="container mx-auto rectangle relative w-4/5 pt-20">
            <div class="flex flex-wrap md:justify-end">
                ...
                >
                    <h2
                        class="title mt-15 font-bold text-white md:text-5xl text-xl w-full"
                    >
                        Simple, transparent pricing
                    </h2>
                    <p
                        class="md:text-lg text-base mb-16 text-white w-full text-center"
                    >
                ...
                <div class="flex flex-wrap w-full justify-between">
                    <div class="w-full">
                        <div class="col-span-6 col-start-3 my-10">
                            <p
                                class="text-ligth_blue text-center text-sm font-bold"
                            >
                                OTHER BENEFITS
                            </p>
                        </div>
                    ...
                    <div
                        class="divide-y divide-gray-300 text-sm w-full md:w-1/5 py-3"
                    >
                        <p class="py-3 font-bold flex items-center">
                            <span>
                                Contribution to funding non-profit open source
                                software
                            </span>
                            <span
                    ...
                    <div
                        class="flex items-center justify-center rounded-lg bg-white divide-y divide-gray-200 py-3 px-8 text-center w-full md:w-1/3 mb-4 md:mb-0"
                    >
                        <p class="py-3 flex justify-center">
                            <img
                                class="w-6 h-6 mx-2"
                                src="~/assets/images/pricing/heart.svg"
                            />
                        </p>
                    </div>
            ...
            <div class="text-center my-32">
                <p class="font-semibold text-4xl text-black">
                    Set up your site, pick a plan later
                </p>
                <p class="text-lg my-8">
                    Try Ghost free for 14 days on our fully managed Ghost(Pro)
                    infrastructure
                </p>
                <p>
                    <a
        ...
        <div class="bg-white rectangle rectangle_blue relative py-32">
            <div class="lg:w-3/5 mx-auto">
                <p class="font-semibold text-black text-4xl text-center">
                    Frequently asked questions
                </p>
                <p class="text-lg text-center text-gray-500 my-10">
                    Looking for more info? Here are some things we're commonly
                    asked
                </p>
                <div class="accordion divide-y divide-gray-300">
                    <div></div>
                    <accordion-item
