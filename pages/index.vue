  ...
  <div class="bg-white">
        ...
        <div class="container mx-auto shoppy-hero--inner">
          <div class="md:flex md:flex-wrap">
            <div class="md:w-1/2 text-center md:text-left md:pt-16">
              ...
              >Sell Digital Goods Online</h1>

              <p class="md:pr-30 text-lg text-white">
                Shoppy is an all-in-one payment processing and e-commerce solution. Accept payments,
                sell digital
                products from your own and more, do it all with a single platform.
              </p>
          ...
          <div class="container mx-auto shoppy-hero--inner">
            <div class="md:flex md:flex-wrap">
              <div class="text-center md:pt-16 md:pb-16 md:w-2/3 mx-auto">
                ...
                <h1 class="font-bold text-4xl leading-tight mb-4">Easy to start, fast to grow</h1>

                <p
                  class="md:pr-30 text-lg"
                >Accept payments, sell digital products from your own and more, do it all with a single platform.</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="container mx-auto shoppy-hero--inner">
              <div class="md:flex md:flex-wrap pb-16">
                <div class="text-center md:pt-16 md:pb-16 md:w-2/3 mx-auto">
                  ...
                  <h1 class="font-bold text-4xl leading-tight mb-4">All-In-One Platform</h1>

                  <p class="md:pr-30 text-lg">
                    Shoppy provides all aspects of an e-commerce solution that you will require. Establish your brand online with instant access to solutions including coupons, customer feedback, analytics and more.
                    You finally have a gorgeous store of your own that reflects the personality of your business.
                  </p>
                </div>
                <div class="md:w-1/2">
                  <img
          ...
          <div class="container mx-auto shoppy-hero--inner">
            <div class="md:flex md:flex-wrap pb-16">
              <div class="text-center md:pt-16 md:pb-16 md:w-2/3 mx-auto">
                ...
                <h1 class="font-bold text-4xl leading-tight mb-4">Automated Delivery</h1>

                <p class="md:pr-30 text-lg">
                  Whether it's a file, serial number, service or even dynamically generated via an API,
                  we provide instant automated delivery of goods to the customer.
                </p>
              </div>
            ...
            <div class="container mx-auto shoppy-hero--inner">
              <div class="md:flex md:flex-wrap pb-16">
                <div class="text-center md:pt-16 md:pb-16 md:w-2/3 mx-auto">
                  ...
                  <h1 class="font-bold text-4xl leading-tight mb-4">Support your Customers</h1>

                  <p
                    class="md:pr-30 text-lg"
                  >Communicate and assist your customers in real time with our support integrations.</p>
                </div>
                <div class="md:w-1/2">
                  <img
                    src="https://ghost.org/static/ghost-admin-home-header-0c20f780aac8e98af7a56076ae8228b8.png"
                ...
                <div class="text-center md:pt-16 md:pb-16 md:w-2/3 mx-auto">
                  <h2 class="text-green uppercase font-bold text-sm mb-4">title here</h2>
                  <h1 class="font-bold text-4xl leading-tight mb-4">Many Gateways and Currencies</h1>

                  <p class="md:pr-30 text-lg">
                    Support a wide range of payment methods including crypto currencies in many different
    ...
    <div class="shoppy-home-pay-box_wrap relative">
      <div class="container mx-auto flex flex-wrap justify-center">
        <img
          src="~assets/images/home/bitcoin.png"
          alt
          class="shoppy-home-pay-box mx-8 my-2 shadow-lg"
        />
        <img
          src="~assets/images/home/paypal.png"
          alt
          class="shoppy-home-pay-box mx-8 my-2 shadow-lg"
        />
        <img
          src="~assets/images/home/litecoin.png"
          alt
          class="shoppy-home-pay-box mx-8 my-2 shadow-lg"
        />
        <img
          src="~assets/images/home/stripe.png"
          alt
          class="shoppy-home-pay-box mx-8 my-2 shadow-lg"
        />
        <img
          src="~assets/images/home/etherium.png"
          alt
          class="shoppy-home-pay-box mx-8 my-2 shadow-lg"
        />
      </div>
          ...
          <div class="container mx-auto shoppy-hero--inner">
            <div class="md:flex md:flex-wrap">
              <div class="text-center md:pt-16 md:pb-6 md:w-2/3 mx-auto">
                ...
                <h1 class="font-bold text-4xl leading-tight mb-4">What our customers say</h1>

                <p class="md:pr-30 text-lg">
                  In 2019 we ran a survey asking Ghost users to share their experiences about what's
                  improved since switching to Ghost, this is what they said:
                </p>
              </div>
            </div>
          </div>
            ...
            >
              ...
              <div class="flex items-center">
                <img
                  ...
                  src="~assets/images/home/face.png"
