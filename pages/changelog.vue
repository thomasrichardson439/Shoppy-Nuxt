            ...
            <div class="px-4 py-2 mt-2">
              <div class="md:flex md:flex-wrap">
                <div class="md:w-2/12 mt-2">
                  <span class="bg-green-400 rounded-lg text-white p-2 text-sm">NEW</span>
                </div>
                <div class="md:w-10/12 border-b pb-6 border-middarkgray-6">
                  <div class="md:flex-shrink-0">
                    <img src="https://ik.imagekit.io/q5edmtudmz/post1_fOFO9VDzENE.jpg" alt="mountains"
                         class="w-full h-64 mb-4">
                  </div>

                  <h2 class="font-bold text-2xl mt-6 mb-3 text-gray-800 tracking-normal">
                    My Amazing Journey to the Mountains
                  </h2>
                  <p class="text-sm text-gray-700 mr-1">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora reiciendis ad architecto at aut placeat
                    quia,
                    minus dolor praesentium officia maxime deserunt porro amet ab debitis deleniti modi soluta similique...
                  </p>
                  ...
                  <div class="author flex items-center -ml-3 my-3">
                    ...
                    <h2 class="text-sm tracking-tighter text-gray-900">
                      <a href="#">By Rotem Bar</a> <span class="text-gray-600">02 JUNE 2020</span>
                    </h2>
                  </div>
                </div>
              </div>
